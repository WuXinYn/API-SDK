...
public class ApiClient
{
    ...
    public Map<String, String> getHeaderMap(String json, String nonce, String host)
    {
        ...
        //hashMap.put("secretKey",secretKey); // 一定不能发送给后端，防止请求被拦截
        // 随机数，防止代理重放
        ...
        // 签名
        hashMap.put(HeaderNameType.Sign.getHeaderName(), getSign(json, secretKey));
        return hashMap;
    }
     ...
     */
    public String handle(BaseRequire<JSONObject> stringBaseRequire, String method, String nonce) throws UnsupportedEncodingException
    {
        String result = "";
